...
public class MainActivity extends AppCompatActivity {
    ...
    // Initializing fields DatabaseHelper myDB;
...
//Call Methods AddData(); viewData(); updateData(); deleteData();
}

//Adding or inserting data to database public void AddData(){
...
//Current Date and Time Date date1 = new Date();
...
//For viewing data in database public void viewData(){
...
//For updating existing data in database public void updateData(){
...
//For deleting data in the database public void deleteData(){

    deleteData.setOnClickListener( new View.OnClickListener() { @Override
        public void onClick(View view) {
        
        id = edit_id.getText().toString();
        
        Integer res = myDB.deleteData( id ); if(res > 0){
